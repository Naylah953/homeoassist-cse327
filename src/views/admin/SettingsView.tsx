...
export function SettingsView() {
  ...
  const Toggle = ({ k, label, desc }: { k: keyof typeof toggles; label: string; desc: string }) => (
    <div className="flex items-center justify-between py-4" style={{ borderBottom: '1px solid #ede9e3' }}>
      <div>
        <p className="text-[17px] font-medium" style={{ color: '#1b2d20' }}>{label}</p>
        <p className="text-[16px]" style={{ color: '#7a7468' }}>{desc}</p>
      </div>
  ...
  return (
    <div>
      ...
      <div className="p-8 grid gap-5" style={{ gridTemplateColumns: '1fr 1fr' }}>
        {/* AI Features */}
        <Card className="p-5">
          <h2 className="text-[20px] font-bold mb-1" style={{ fontFamily: 'var(--font-display)' }}>AI Features</h2>
          <p className="text-[16px] mb-4" style={{ color: '#7a7468' }}>Control AI-powered modules platform-wide</p>
        ...
        {/* Notifications */}
        <Card className="p-5">
          <h2 className="text-[20px] font-bold mb-1" style={{ fontFamily: 'var(--font-display)' }}>Notifications</h2>
          <p className="text-[16px] mb-4" style={{ color: '#7a7468' }}>Delivery channels for alerts and reminders</p>
        ...
        {/* Platform Controls */}
        <Card className="p-5">
          <h2 className="text-[20px] font-bold mb-1" style={{ fontFamily: 'var(--font-display)' }}>Platform Controls</h2>
          <p className="text-[16px] mb-4" style={{ color: '#7a7468' }}>Core platform availability settings</p>
        ...
        {/* Data Export */}
        <Card className="p-5">
          <h2 className="text-[20px] font-bold mb-1" style={{ fontFamily: 'var(--font-display)' }}>Data & Exports</h2>
          <p className="text-[16px] mb-4" style={{ color: '#7a7468' }}>Download platform reports and backups</p>
          <div className="flex flex-col gap-2">
            {[
              ...
              <button key={i}
                className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-[15px] font-medium w-full text-left transition-colors hover:bg-[#f5f2ed]"
                style={{ border: '1px solid #d6d0c8', color: '#1b2d20' }}>
                <span style={{ color: 'var(--color-primary)' }}><Ico d={IC.download} size={15} /></span>
                {item}
              </button>
            ))}
          </div>
