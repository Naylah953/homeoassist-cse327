...
import { DOCTORS, APPOINTMENTS, PRESCRIPTIONS, CHAT_HISTORY, EXTRACTED_SYMPTOMS, ON_CALL_DOCTORS } from './data/patientMockData';
    ...
    <div className="flex" style={{ height: '100%' }}>
      ...
      <div className="flex flex-col" style={{ width: 300, flexShrink: 0, background: '#f5f2ed' }}>
        <div className="px-5 py-4" style={{ borderBottom: '1px solid #d6d0c8' }}>
          ...
          <p className="text-[11px] mt-0.5" style={{ color: '#7a7468' }}>Extracted Symptoms as you chat</p>
        </div>
